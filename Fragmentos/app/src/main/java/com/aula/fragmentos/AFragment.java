...
public class AFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        envelope.putString("chave", "valor");

        Button botao = view.findViewById(R.id.bt);
        botao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NavController navController = NavHostFragment.findNavController(AFragment.this);
                Navigation.findNavController(view).navigate(R.id.action_AFragment_to_BFragment, envelope);
            }
        });
        return view;
